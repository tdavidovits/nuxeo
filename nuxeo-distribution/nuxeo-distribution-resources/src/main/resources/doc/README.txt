# Nuxeo platform 5.5.0-HF21-SNAPSHOT Release Notes

Welcome to the Nuxeo Platform 5.5.0-HF21-SNAPSHOT.
...
The applications based on Nuxeo EP 5.5.0-HF21-SNAPSHOT need Java. Please install and
set up the recommended [Sun Java Development Kit (JDK) 6][2] if it's not
already installed on your computer.

Nuxeo Platform 5.5.0-HF21-SNAPSHOT supports OpenJDK 6 as a default Java setup.
